...
contract BullBear is ERC721, ERC721Enumerable, ERC721URIStorage, KeeperCompatibleInterface, Ownable, VRFConsumerBaseV2  {
    ...
    bytes32 keyhash =  0x474e34a077df58807dbe9c96d3c009b23b3c6d0cce433e59bbf5b34f823bc56c; // keyhash for sepolia, see https://docs.chain.link/vrf/v2/subscription/supported-networks
    ...
    */
    ...
    // BTC/USD Price FeedAddress on Sepolia: 0x1b44F3514812d835EB1BDB0acB33d3fA3351Ee43
    // Setup VRF. Sepolia VRF Coordinator 0x8103B0A8A00be2DDC778e6e7eaa21791Cd364625    
    constructor(uint updateInterval, address _pricefeed, address _vrfCoordinator) ERC721("Bull&Bear", "BBTK")
